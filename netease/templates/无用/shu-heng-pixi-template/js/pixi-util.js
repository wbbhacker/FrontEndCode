...
(function() {
    ...
    */
    ...
    /*
        data.objData = [
                {
                    name:'tip1',
                    url:'img/content/1.png?v=1511231615',
                    type:'Sprite',
                    prop:{
                        x:1706,
                        y:559,
...

                {
                    ...
                    children:[
                        {
                            name:'img/kv/kv-bg.jpg?v=1511231615',
                            url:'img/kv/kv-bg.jpg?v=1511231615',
                            type:'Sprite',
                            prop:{
                                x:0,
                                y:0
    ...
    */ 
    ...
    /*
        var bg1 = longBg('img/content/sky',10,'.jpg?v=1511231615')
    */ 
