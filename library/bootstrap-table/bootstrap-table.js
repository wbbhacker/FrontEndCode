...
/*修改表单搜索样式**/
        if (this.options.search) {
            html = [];
            html.push(
                '<div class="pull-' + this.options.searchAlign + ' search table-search">',
                sprintf('<input class="form-input' +
                    sprintf(' input-%s', this.options.iconSize) +
                    '" type="text">',
                    this.options.formatSearch()),
                '<a href="javascript:void(0);" id="search-table"></a></div>');
            ...
            $search.off('keyup drop').on('keyup drop', function (event) {
             ...
             $("body").on("click","#search-table",function(event){
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            if( this.options.pageNumber == 1 ){
                 $pre.find("a").css("color","#ccc");
            }
            if( this.options.pageNumber == this.options.totalPages){
                $next.find("a").css("color","#ccc");
            }
    ...
    BootstrapTable.prototype.resetView = function (params) {
        ...
        if (this.options.height) {
            var toolbarHeight = getRealHeight(this.$toolbar),
                ...
                height = this.options.height - toolbarHeight - paginationHeight-310;
